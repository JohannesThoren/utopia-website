...
// TODO add a description card for the board, containing the board title and description.
...
<template>
  <div id="board">
    ...
    <div>
      ...
      <NewPost v-if="b_show_new_post" @close-new-post="b_show_new_post = false"/>
    </div>
...
export default {
  ...
  async created() {
    let data = await api_get_call(this.$store.state.api_root, `board/get/id/${this.str_board_id}`) 
